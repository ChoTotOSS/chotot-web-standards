...
test({
  valid: [
    ...
    testCase('src/foo/[fooBar].js', 'camelCase'),
    testCase('src/foo/{foo_bar}.js', 'snakeCase'),
    testCaseWithOptions(undefined, undefined, [{ case: 'kebabCase', ignore: ['FOOBAR\\.js'] }]),
    testCaseWithOptions(undefined, undefined, [{ case: 'kebabCase', ignore: [/FOOBAR\.js/u] }]),
    ...
    testCaseWithOptions('src/foo/foo.js', undefined, [{ case: 'kebabCase', ignore: ['^(F|f)oo'] }]),
