...
function prototypeMethodSelector(options) {
  const { path, object, method, methods } = {
    path: '',
    method: '',
    methods: [],
    ...options,
...
const arrayPrototypeMethodSelector = (options) =>
  prototypeMethodSelector({ ...options, object: 'Array' });
const objectPrototypeMethodSelector = (options) =>
  prototypeMethodSelector({ ...options, object: 'Object' });
