...
module.exports = {
  ...
  arrayPrototypeMethodSelector: require('./prototype-method-selector.js')
    .arrayPrototypeMethodSelector,
  objectPrototypeMethodSelector: require('./prototype-method-selector.js')
  ...
  callOrNewExpressionSelector: require('./call-or-new-expression-selector.js')
