...
@returns {string}
*/
export const callExpressionSelector = (options) => create(options, ['CallExpression']);

/**
@param {CallOrNewExpressionOptions} [options]
@returns {string}
*/
export const newExpressionSelector = (options) => create(options, ['NewExpression']);

/**
@param {CallOrNewExpressionOptions} [options]
@returns {string}
*/
export const callOrNewExpressionSelector = (options) =>
  create(options, ['CallExpression', 'NewExpression']);
